...
/**
 * React 19 note:
 * Radix + forwardRef can trigger the "element.ref was removed" warning depending on versions.
 * We avoid forwarding refs here entirely. (Viewport doesn't need your ref anyway.)
 */
...
/**
 * For Root/Action/Close/Title/Description we can keep forwardRef.
 * If your Radix version still screams, upgrade @radix-ui/react-toast.
 */
    ...
    <ToastPrimitives.Action
      ...
      className={cn(
        "inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium ring-offset-background transition-colors " +
          ...
          "group-[.destructive]:border-muted/40 hover:group-[.destructive]:border-destructive/30 " +
